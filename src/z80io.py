...
class IO:
    def __init__(self):
        ...
        self.register_in_cb(0x0C, self.handle_uio_0c_in)
        self.register_in_cb(0x1A, self.handle_uio_1a_in)
    ...
    ### Unknown IO1
    def handle_uio_0c_in(self) -> int:
        print('IO - unknown input (0x0C), return 0')
        return 0

    ### Unknown IO2
    def handle_uio_1a_in(self) -> int:
        print('IO - unknown input (0x1a), return 0')
        return 0
