...
jdc = {
    ...
    "pois" : {
        ...
        0x0239: 'is disk 2 on track 0???',
        0x0249: 'get display width',
        0x0252: 'print " Q1-Magnus"',
        0x0258: 'display char/string',
        0x0260: 'print " Klar til brug"',
        0x0264: 'get display status',
        0x0266: 'check if 40 or 80 bytes',
        0x0273: 'get keyboard input (command line?)',
