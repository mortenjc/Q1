...
jdc = {
    ...
    "pois" : {
        ...
        0x18df: 'INST 33 - byte 2 and 3 is binary number, stacked',
        0x18ea: 'INST 32 - byte 2 is binary number, stacked',
        0x18f5: 'INST 1A - Convert from decimal to character',
        0X18fb: 'INST 1E - Call to address on top of the stack',
        0x1938: 'INST 1F - return from subroutine',
        0x1939: 'INST 24 - Get decimal number from input',
        0x193f: 'INST 2A - Output character N times',
        0x194a: 'INST 23 - Get new line of keyboard input',
        0x1950: 'INST 25 - Get character string from input',
        0x1958: 'INST 27 - Put decimal number',
        0x196b: 'INST 26 - Put character string',
        0x1973: 'INST 28 - Put Edit character string',
        0x1992: 'INST 06 - store a string of bytes',
        0x19b9: 'INST 31 - store string (no padding)',
        0x19db: 'INST 29 - Put Edit decimal number',
        0x1ae8: 'INST 16 - Convert from character to binary',
        0x1aea: 'call CARB (ch to binary)',
        0x1af1: 'INST 18 - Convert from binary to decimal',
        0x1b05: 'call BICHAR',
        0x1b0a: 'call TOSTR',
        0x1b20: 'INST 19 - Convert from binary to character',
        0x1b24: 'call TODEC',
        0x1b2c: 'INST 12 - And binary',
        0x1b38: 'INST 13 - Or binary',
        0x1b44: 'INST 14 - Ones complement binary',
        ...
        0x1bca: 'call OPEN',
        0x1bd0: 'INST 2F - file description on top of stack',
        0x1bd7: 'INST 17 - Convert from character to decimal',
        ...
        0x1d2b: 'hl = IPC addr',
        0x1d34: 'INST 1C - Go to address on top of stack',
        0x1d38: 'INST 1D - Go to address on top of stack (conditional)',
        0x1d3c: 'run microcode program',
        0x1d42: 'INST 21 - Do loop control for decimal indexes',
        0x1d61: 'INST 20 - Do loop control for binary indexes',
    ...
    "known_ranges" : [
        ...
        [0x0048, 0x0051, 'UNEXPLORED'],
        [0x0052, 0x0054, 'interrupt38 chain'],
        [0x0055, 0x00f3, 'UNEXPLORED'],
        [0x00f4, 0x0106, 'binary to hex?'],
        [0x0107, 0x01dd, 'UNEXPLORED'],
